...
qk.passport = (function(){
    ...
    var normalLogin = function(jumpurl){
        ...
        var url = "//i360mall.com/login?t="+(new Date().getTime())+"&returnUrl=" + encodeURIComponent(href);
...
function selectDirection(dom) {
    ...
    switch(dataMonitor) {
        ...
        case "h5_v1home_menu_shopcart" :  window.location.href = "/shop_cart.html";
            break;
        case "h5_allproduct_order_click" :
        case "h5_home_menu_user" :  window.location.href = "/usercenter.html";
            break;
        default: ;
    }
}
...
// baseRoutePrefix = '';
baseRouteServicePrefix = '/proxy/b2c-h5-node-service'; //ajax异步调用接口
// baseRouteServicePrefix = '';
baseRouteUploadPrefix = '/proxy/zuul/b2c-h5-node-service'; //上传使用的接口